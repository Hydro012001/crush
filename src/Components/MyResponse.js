...
function MyResponse({ agree, handleClose }) {
  ...
  const handleSubmitResponse = async () => {
    ...
    try {
      ...
      setShowLoader(false);
      alert(
        "I have accept you response. Thank you, Thank you bisan dugay siya nakuha and fail man gabie but I cannot dislike you. I still like bisan nahitabo to bisan na abtan pa ug karn. I hope dili ko bandage is imong life after you have healed and use it you will throw it. I hope so ug dili. Active naka sa uban sa?"
      );
      navigate("/slider");
    } catch (error) {
      console.log(error);
